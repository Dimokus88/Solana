...
exec solana-validator --expected-genesis-hash 4uhcVJyU9pJkvQyS88uRDiswHXSCkY3zQawwpjk2NsNY --entrypoint entrypoint.testnet.solana.com:8001 --entrypoint entrypoint2.testnet.solana.com:8001 --entrypoint entrypoint3.testnet.solana.com:8001 --known-validator 5D1fNXzvv5NjV1ysLjirC4WY92RNsVH18vjmcszZd8on --known-validator dDzy5SR3AXdYWVqbDEkVFdvSPCtS9ihF5kJkHCtXoFs --known-validator Ft5fbkqNa76vnsjYNwjDZUXoTWpP7VYm3mtsaQckQADN --known-validator eoKpUABi59aT4rR9HGS3LcMecfut9x7zJyodWWP43YQ --known-validator 9QxCLckBiJc783jnMvXZubK4wH86Eqqvashtrwvcsgkv --rpc-port 8899 --dynamic-port-range 8000-8015 --identity /root/solana/validator-keypair.json --vote-account /root/solana/vote-account-keypair.json --ledger /root/sol/ledger --rocksdb-shred-compaction fifo --wal-recovery-mode skip_any_corrupted_record --no-os-network-limits-test --accounts-db-skip-shrink --no-port-check --log /root/solana/solana.log
EOF
